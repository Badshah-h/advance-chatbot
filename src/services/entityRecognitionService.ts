...
const synonymMap: Record<string, string[]> = {
  // Service types
  'visa': ['entry permit', 'residence permit', 'visit visa', 'tourist visa', 'entry permission'],
  'passport': ['travel document', 'passport renewal', 'passport application'],
  'emirates id': ['national id', 'identity card', 'eid', 'id card', 'identification'],
  'driving license': ['driver license', 'driving permit', 'driver permit', 'driving licence'],
  'business license': ['trade license', 'commercial license', 'business permit', 'commercial registration'],
  'marriage': ['wedding', 'matrimony', 'marriage certificate', 'marriage registration'],
  'birth certificate': ['birth registration', 'birth document', 'newborn registration'],
  'death certificate': ['death registration', 'death document'],
  'vehicle registration': ['car registration', 'auto registration', 'vehicle permit'],
  'traffic fine': ['traffic violation', 'traffic penalty', 'driving fine', 'road fine'],
  
  // Ministries and authorities
  'ministry of interior': ['moi', 'interior ministry', 'police'],
  'ministry of foreign affairs': ['mofa', 'foreign ministry', 'diplomatic'],
  'federal authority for identity': ['identity authority', 'ica', 'immigration'],
 ...
 */
function extractServiceTypes(query: string, entities: RecognizedEntity[]): void {
  const serviceTypes = [
 ...
 */
function extractDocumentTypes(query: string, entities: RecognizedEntity[]): void {
  const documentTypes = [
    { text: 'passport', confidence: 0.9 },
    { text: 'emirates id', confidence: 0.9 },
    { text: 'driving license', confidence: 0.9 },
 ...
 */
function extractOrganizations(query: string, entities: RecognizedEntity[]): void {
  const organizations = [
    ...
    { text: 'ministry of community development', confidence: 0.9, type: 'MINISTRY' },
    { text: 'ministry of cabinet affairs', confidence: 0.9, type: 'MINISTRY' },
    { text: 'ministry of presidential affairs', confidence: 0.9, type: 'MINISTRY' },
    ...
    { text: 'ministry of artificial intelligence', confidence: 0.9, type: 'MINISTRY' },
    { text: 'ministry of possibilities', confidence: 0.9, type: 'MINISTRY' },
    { text: 'federal authority for identity', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'federal tax authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'federal transport authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'securities and commodities authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'general civil aviation authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'telecommunications regulatory authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'insurance authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'federal customs authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'federal electricity and water authority', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'general authority of islamic affairs', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'general pension and social security authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'federal demographic council', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'federal competitiveness and statistics authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'federal authority for government human resources', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'federal authority for nuclear regulation', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'abu dhabi economic department', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'fujairah economic department', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'ras al khaimah economic department', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'umm al quwain economic department', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'dubai roads and transport authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'abu dhabi department of transport', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'dubai electricity and water authority', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'abu dhabi distribution company', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'dubai courts', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'abu dhabi judicial department', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'abu dhabi chamber of commerce', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'dubai knowledge and human development authority', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'dubai multi commodities centre', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'dubai international financial centre', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'dubai international academic city', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'dubai international humanitarian city', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'dubai biotechnology and research park', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'dubai car and automotive city free zone', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'abu dhabi international airport', confidence: 0.9, type: 'AUTHORITY' },
    { text: 'sharjah international airport', confidence: 0.9, type: 'AUTHORITY' },
    ...
    { text: 'dubai fruit and vegetable market', confidence: 0.9, type: 'AUTHORITY' },
 ...
 * Determine intents based on query and entities
 */
function determineIntents(query: string, entities: RecognizedEntity[], intents: Array<{intent: string; confidence: number}>): void {
  ...
  const actionIntents = [
    ...
    { action: 'have a good investigation', intent: 'FAREWELL', confidence: 0.9 },
    ...
    { action: 'have a good routing number', intent: 'FAREWELL', confidence: 0.9 },
    { action: 'have a good account number', intent: 'FAREWELL', confidence: 0.9 },
    ...
    { action: 'have a good expiration date', intent: 'FAREWELL', confidence: 0.9 },
    { action: 'have a good security code', intent: 'FAREWELL', confidence: 0.9 },
    { action: 'have a good verification code', intent: 'FAREWELL', confidence: 0.9 },
    { action: 'have a good authentication code', intent: 'FAREWELL', confidence: 0.9 },
    ...
    { action: 'have a good shut', intent: 'FAREWELL', confidence: 0.9 },
    { action: 'have a good stop', intent: 'FAREWELL', confidence: 0.9 },
    { action: 'have a good pause', intent: 'FAREWELL', confidence: 0.9 },
    { action: 'have a good resume